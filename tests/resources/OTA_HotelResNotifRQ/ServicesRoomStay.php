        ...
        <HotelReservation CreateDateTime="2012-03-09T21:31:52+02:00">
            ...
            <RoomStays>
                <RoomStay>
                        ...
                        <RoomRate RoomTypeCode="ROOM1" RatePlanCode="RATE1" NumberOfUnits="1">
                            <Rates>
                                <Rate UnitMultiplier="1" RateTimeUnit="Day" EffectiveDate="2012-03-12" ExpireDate="2012-03-14">
                                    <Base AmountBeforeTax="454.55" AmountAfterTax="500.00" CurrencyCode="AUD"/>
                                    <Total AmountBeforeTax="454.55" AmountAfterTax="500.00" CurrencyCode="AUD"/>
                                </Rate>
                            </Rates>
                        </RoomRate>
                    </RoomRates>
                    ...
                    <Total AmountAfterTax="505.00" CurrencyCode="AUD">
                    </Total>
            ...
            <ResGlobalInfo>
                ...
                <Total CurrencyCode="AUD" AmountAfterTax="505.00">
                </Total>
                <Guarantee>
                    <GuaranteesAccepted>
                        <GuaranteeAccepted>
