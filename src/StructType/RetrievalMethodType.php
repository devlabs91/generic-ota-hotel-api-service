...
class RetrievalMethodType extends AbstractStructBase
{
     ...
     * @param string $type
     */
    public function __construct(\Devlabs91\GenericOtaHotelApiService\StructType\TransformsType $transforms = null, $uRI = null, $type = null)
    {
        $this
     ...
     * @param \Devlabs91\GenericOtaHotelApiService\StructType\TransformsType $transforms
     * @return \Devlabs91\GenericOtaHotelApiService\StructType\RetrievalMethodType
     */
