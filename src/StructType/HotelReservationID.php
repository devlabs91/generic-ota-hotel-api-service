...
class HotelReservationID extends AbstractStructBase
{
     ...
     * The ResID_Type
     * Meta informations extracted from the WSDL
     * - documentation: Defines the type of Reservation ID (e.g. reservation number, confirmation number, cancellation number). Refer to OTA Code List Unique ID Type (UIT).
     * - use: optional
     * @var string
     */
    public $ResID_Type;
     ...
     * Meta informations extracted from the WSDL
     * - default: false
     * - documentation: Used to determine if the ResID_Value is given to guest
     * @var bool
     */
    public $ForGuest;
    /**
     ...
     */
    public function __construct($resID_Type = null, $resID_Value = null, $resID_Source = null, $resID_SourceContext = null, $resID_Date = null, $forGuest = false, $resGuestRPH = null, $cancelOriginatorCode = null, $cancellationDate = null)
    {
        $this
     ...
     * @return \Devlabs91\GenericOtaHotelApiService\StructType\HotelReservationID
     */
    public function setForGuest($forGuest = false)
    {
